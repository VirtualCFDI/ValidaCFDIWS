...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:nomina="http://www.sat.gob.mx/nomina">
	...
	-->
	<xsl:include href="3.2/utilerias.xslt"/>
	<!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
	<xsl:include href="3.2/ecc.xslt"/>
	<xsl:include href="3.2/psgecfd.xslt"/>
	<xsl:include href="3.2/donat11.xslt"/>
	<xsl:include href="3.2/divisas.xslt"/>
	<xsl:include href="3.2/ecb.xslt"/>
	<xsl:include href="3.2/detallista.xslt"/>
	<xsl:include href="3.2/implocal.xslt"/>
	<xsl:include href="3.2/terceros11.xslt"/>
	<xsl:include href="3.2/iedu.xslt"/>
	<xsl:include href="3.2/ventavehiculos.xslt"/>
	<xsl:include href="3.2/pfic.xslt"/>
	<xsl:include href="3.2/TuristaPasajeroExtranjero.xslt"/>
	<xsl:include href="3.2/leyendasFisc.xslt"/>
	<xsl:include href="3.2/nomina11.xslt"/>	
